...
train_path = Config.tfrecord_path + 'trian/'
...
#使用 shuffle_batch 随机打乱输入
train_img,train_label = read_and_decode([train_path + 'train.tfrecords'])
train_img_batch ,train_label_batch = tf.train.shuffle_batch([train_img,train_label],batch_size=1,capacity=10000)
...
val_img_batch, val_label_batch = tf.train.batch([val_img, val_label],batch_size=1, capacity=1000)
